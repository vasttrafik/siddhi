...
public abstract class AttributeAggregator implements EternalReferencedHolder, Snapshotable {
	...
	public void initAggregator(ExpressionExecutor[] attributeExpressionExecutors,
		...
		try {
			...
			// Not added to Snapshotable as the AggregationAttributeExecutors
			// are added
	...
	public AttributeAggregator cloneAggregator(String key) {
		try {
			...
			attributeAggregator.cloned = true;
	 ...
	 *            are the executors of each attributes in the function
	 * @param executionPlanContext
	 *            Execution plan runtime context
	 */
	protected abstract void init(ExpressionExecutor[] attributeExpressionExecutors,
			ExecutionPlanContext executionPlanContext);
